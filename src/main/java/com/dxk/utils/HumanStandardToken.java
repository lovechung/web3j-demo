...
public class HumanStandardToken extends Contract {
    ...
    public List<ModifiedEventResponse> getModifiedEvents(TransactionReceipt transactionReceipt) {
        ...
        ArrayList<ModifiedEventResponse> responses = new ArrayList<>(valueList.size());
    ...
    public RemoteCall<TransactionReceipt> newGreeting(String _greeting) {
        Function function = new Function(
                "newGreeting",
                Collections.singletonList(new Utf8String(_greeting)),
                Collections.emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public static RemoteCall<HumanStandardToken> deploy(Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit, String _greeting) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Collections.singletonList(new Utf8String(_greeting)));
